INSERT INTO m_feed_account VALUES('yahoo01','デイリーランキング - 急上昇ワード - Yahoo!検索データ','http://searchranking.yahoo.co.jp/rss/burst_ranking-rss.xml',1,1,DATE_FORMAT(now(),'%Y/%m/%d'));

https://allcoupon.jp/api-v2/coupon?area=[エリアコード]&output=[データフォーマット]
...
芸スポ速報+
http://2ch-ranking.net/rss/mnewsplus.rdf


お詫び+:2ch勢いランキング
http://2ch-ranking.net/rss/owabiplus.rdf

痛いニュース+:2ch勢いランキング
http://2ch-ranking.net/rss/dqnplus.rdf

----------------------------------------------------

****２ちゃんねる勢いランキング ニュース勢いTOP50
****http://www.ikioi2ch.net/rss/single/news.xml

２ちゃんねる勢いランキング ニュー速VIP勢いTOP50
http://www.ikioi2ch.net/rss/single/vip.xml

２ちゃんねる勢いランキング サブカルチャー勢いTOP5
http://www.ikioi2ch.net/rss/single/subculture.xml

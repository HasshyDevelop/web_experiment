      ...
      <p>
      このテンプレートは<a href="http://www.famfamfam.com/lab/icons/silk/">famfamfam.com</a>や<a href="http://dots-design.com/">フリーWEB素材サイト「DOTS DESIGN(ドッツ・デザイン)」</a>のようなミニマムなアイコンがすごく似合うと思います。上部のアイコンは当サイトのオリジナルになります。もし他のサイトで配布しているアイコンを使用する場合は、それぞれのライセンス規約にしたがって使用してください。
      </p>
      <h3>カスタマイズについて</h3>
      <p>
      ...
      <h2>フォトサンプル</h2>
      <div class="pola">
         <img src="images/photo01.jpg" alt="" /><p>小さなお花が咲きました。</p>
      </div><!-- /.pola-->
      <p>
      ...
      <ul class="pola">
         <li><img src="images/photo02.jpg" alt="" /><p>桜も満開の季節です。空が今日もきれいです。自動に縦方向の高さを補正してくれます。</p></li>
         <li><img src="images/photo03.jpg" alt="" /><p>小さなお花が咲きました。</p></li>
         <li><img src="images/photo04.jpg" alt="" /><p>空が今日もきれいです。長文ももちろんかけますよ。</p></li>
         <li><img src="images/photo02.jpg" alt="" /><p>桜も満開の季節です。</p></li>
         <li><img src="images/photo03.jpg" alt="" /><p>小さなお花が咲きました。</p></li>
         <li><img src="images/photo04.jpg" alt="" /><p>空が今日もきれいです。長文ももちろんかけますよ。</p></li>
         <li><img src="images/photo04.jpg" alt="" /><p>空が今日もきれいです。長文ももちろんかけますよ。</p></li>
      </ul><!-- /.pola-->
